...
import { InternshipOffer, InternshipOfferRequest, OfferStatusUpdateRequest } from './app/models/offer.model';
@Injectable({
  providedIn: 'root'
})
export class OfferService {
  ...
  getCompanyOffers(page = 0, size = 10): Observable<any> {
    ...
    return this.apiService.get<any>('/companies/me/offers', params);
  }
}
