        ...
        <div class="bg-white rounded-lg shadow-sm border border-primary-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-primary-900">{{companies.filter(c => c.enabled).length}}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-primary-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-primary-900">{{companies.reduce((sum, c) => sum + (c.offersCount || 0), 0)}}</p>
            </div>
          </div>
        </div>
      </div>
