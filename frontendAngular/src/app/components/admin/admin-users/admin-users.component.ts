          ...
          <table class="w-full">
            ...
            <tbody>
              <tr *ngFor="let user of users" class="border-b border-primary-100">
                ...
                <td class="px-4 py-3">
                  <span [ngClass]="user.actif ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'" 
        ...
        <form (ngSubmit)="saveUser()" #userForm="ngForm">
          <div class="space-y-4">
            <div>
              ...
              <input [(ngModel)]="currentUser.prenom" name="prenom" required 
                     class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2">
            </div>
            
            <div>
              <label class="block text-sm font-medium text-gray-700">Nom</label>
              <input [(ngModel)]="currentUser.nom" name="nom" required 
                     class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2">
            </div>
            ...
            <div>
              ...
              <input [(ngModel)]="currentUser.telephone" name="telephone" 
                     class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2">
            </div>
          </div>
